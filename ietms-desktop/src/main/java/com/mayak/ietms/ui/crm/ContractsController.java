...
import com.mayak.ietms.infrastructure.form.LaneForm;
...
public class ContractsController implements SecuredView,ViewLifecycle {
    ...
    public void initialize() {
        TextUtils.allowOnlyLatin(laneIdTextField, fromTextField, toTextField, priceTextField, fuelSurchargeTextField);
